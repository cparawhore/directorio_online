...
$app->get('/', function () use ($app){
    try{
		...
		$dbh = $connection->prepare("SELECT *,curdate() - created_at as diferencia FROM inmuebles WHERE created_at >= DATE_SUB(CURDATE(), INTERVAL 60 DAY) ORDER BY ID DESC LIMIT 8");
